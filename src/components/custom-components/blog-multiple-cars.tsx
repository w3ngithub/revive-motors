            ...
            <div className="col-span-5      ">
              ...
              <div className="max-w-[405px] bg-white  flex flex-col justify-start items-center    ">
                ...
                <div className="p-5  flex flex-col gap-4 2xl:pl-4 ">
                  ...
                  <a href="#">
                    {/* 375px */}
                    <h4 className="mb-2 text-t1 font-bold tracking-tight text-gray-900 dark:text-white 2xl:pl-4      2xl:max-w-[375px]">
                      5 Genius Car Accessories You Should Never Drive Without
                    </h4>
                  </a>
                  <p className=" mb-3 text-b2 font-semibold text-customColor-grey leading-relaxed 2xl:pl-4 max-w-[405px]    ">
