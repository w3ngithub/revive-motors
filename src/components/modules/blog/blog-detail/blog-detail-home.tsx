  ...
  return (
    <section className="container">
      <article className=" max-w-4xl mx-auto px-4 py-8">
        ...
        <h3 className="text-h3 font-bold mb-4 max-2xl:max-w-[750px] max-2xl:leading-tight">
          Should I Buy a New Car or Lease a New Car in 2021?
        </h3>
        <p className="text-b2 font-semibold text-customColor-grey mb-8 max-2xl:max-w-[750px] ">
